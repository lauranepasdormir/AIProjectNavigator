...
interface SubmissionTableProps {
  submissions: ProjectSubmission[];                        // List of project submissions
  onView: (submission: ProjectSubmission) => void;         // View submission handler
  onDelete: (submission: ProjectSubmission) => void;       // Delete submission handler
  onDownload: (submission: ProjectSubmission) => void;     // Download submission handler
}
...
export default function SubmissionTable({
  ...
  // Limits for truncating long strings
  const charLimit = 80;
  const wordLimit = 9;
                ...
                >
                  {(() => {
                    ...
                    if (status.length > charLimit)
                      return status.slice(0, charLimit) + "...";
                    if (words.length > wordLimit)
                      return words.slice(0, wordLimit).join(" ") + "...";
                    return status;
                  })()}
